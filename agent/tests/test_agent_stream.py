...
class FakeQueryAnalyzer:
    def analyze(self, question: str, top_k=None, memory_context=None, user_context=None):
        return QueryPlan(
...
class FakeAnswerGenerator:
    def stream_generate(self, question, query_plan, evidence, total, memory_context=None, user_context=None, evidence_status="not_checked"):
        return iter(["流", "式", "回答"]), [], [], []


class FakeValidationTool:
    def run(self, question, answer, evidence, evidence_status="not_checked"):
